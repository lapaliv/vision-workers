...
def main():
    ...
    download_file(
        ...
        cache_dir="/app/ComfyUI/models/caches",
    )
    ...
    download_file(
        ...
        local_dir="/app/ComfyUI/models/embeddings",
        cache_dir="/app/ComfyUI/models/caches",
    )
    ...
    if not os.path.exists("/app/ComfyUI/input/init.png"):
        os.rename("/app/ComfyUI/input/example.png", "/app/ComfyUI/input/init.png")
    if not os.path.exists("/app/ComfyUI/input/mask.png"):
        subprocess.run(["cp", "/app/ComfyUI/input/init.png", "/app/ComfyUI/input/mask.png"], check=True)

    logger.info("Cloning ComfyUI-Inspire-Pack")
    clone_repo(
        repo_url="https://github.com/ltdrdata/ComfyUI-Inspire-Pack",
        target_dir="/app/ComfyUI/custom_nodes/ComfyUI-Inspire-Pack",
    ...
    clone_repo(
        ...
        target_dir="/app/ComfyUI/custom_nodes/ComfyUI_IPAdapter_plus",
    ...
    clone_repo(
        ...
        target_dir="/app/ComfyUI/custom_nodes/ComfyUI_InstantID",
    ...
    download_file(
        ...
        local_dir="/app/ComfyUI/models/insightface/models",
        cache_dir="/app/ComfyUI/models/caches",
    )
    if not os.path.exists("/app/ComfyUI/models/insightface/models/antelopev2"):
        subprocess.run(
            ["unzip", "/app/ComfyUI/models/insightface/models/antelopev2.zip", "-d", "ComfyUI/models/insightface/models"],
            check=True,
        )
    ...
    download_file(
        ...
        local_dir="/app/ComfyUI/models/instantid",
        cache_dir="/app/ComfyUI/models/caches",
    )
